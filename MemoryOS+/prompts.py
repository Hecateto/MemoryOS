...
GENERATE_SYSTEM_RESPONSE_USER_PROMPT = (
    ...
    "Please respond to the user's statement using the following format (maximum 30 words):\n "
...
MULTI_SUMMARY_SYSTEM_PROMPT = (
    "You are an expert in analyzing and synthesizing dialogue topics. "
    "Your task is to generate EXACTLY ONE comprehensive summary object that encapsulates the entire dialogue. "
    "Even if the dialogue covers multiple different aspects, you MUST merge them into a single, unified summary. "
    "Never split the output into multiple topics."
)

MULTI_SUMMARY_USER_PROMPT = (
    "Please analyze the following dialogue and synthesize it into EXACTLY ONE extremely concise summary.\n\n"
    "Guidelines:\n"
    "1. Theme: Provide a unified theme that covers all discussed aspects (e.g., '自我介绍与工作探讨').\n"
    "2. Keywords: Combine all relevant keywords from different aspects into a single list.\n"
    "3. Content: Write a single concise sentence describing all points discussed.\n\n"
    "You MUST output a JSON array containing EXACTLY ONE element. Format strictly as follows:\n"
    "[\n"
    "  {{\n"
    "    \"theme\": \"Combined theme of all aspects\",\n"
    "    \"keywords\": [\"key1\", \"key2\", \"key3\", \"key4\"],\n"
    "    \"content\": \"Comprehensive summary of aspect 1 and aspect 2\"\n"
    "  }}\n"
    "]\n\n"
    "Conversation content:\n{text}"
)
